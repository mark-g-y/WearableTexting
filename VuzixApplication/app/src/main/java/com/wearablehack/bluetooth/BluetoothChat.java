package com.wearablehack.bluetooth;
/*
...
public class BluetoothChat extends Activity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_WRITE:
                    ...
                    if ("call_toggle".equals(writeMessage)) {
                        break;
                    }
                ...
                case MESSAGE_READ:
                    ...
                    // parse to see who is sending the message
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event){
        ...
        switch(keyCode) {
            case KeyEvent.KEYCODE_DPAD_RIGHT: // SELECT button pressed, 66
                correctKey = true; // expected button pressed
                sendMessage("call_toggle");
                break;
